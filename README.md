...
Thêm dòng sau (thay YOUR_PYTHON_PATH bằng đường dẫn đến file thực thi Python của bạn):
...
Bấm Submit để thực hiện giấu thông tin.
...
Bấm Submit để giải mã và xem nội dung.